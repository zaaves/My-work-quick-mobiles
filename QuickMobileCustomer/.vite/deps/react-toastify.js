...
function gt({
  ...
  let C = clsx_default(
    ...
    S = P(l)
      ? l({ rtl: c, type: r2, defaultClassName: C })
      : clsx_default(C, l),
    E = {
    ...
    buildToast: (i, n) => {
      ...
      (A.closeButton = d.closeButton),
        n.closeButton === false || z(n.closeButton)
          ...
          : n.closeButton === true &&
            (A.closeButton = z(d.closeButton) ? d.closeButton : true);
...
function It(t) {
  ...
  let {
    ...
    getSnapshot: e,
    setProps: r2,
  } = (0, import_react7.useRef)(Et(t)).current;
  r2(t);
  let s =
    (a = (0, import_react7.useSyncExternalStore)(o, e, e)) == null
      ? void 0
      : a.slice();
  function l(d) {
    if (!s) return [];
